...
package Kernel::Modules::AdminDynamicFieldCalculation;
...
sub _AddAction {
    ...
    for my $ConfigParam (qw(ObjectType ObjectTypeName FieldType FieldTypeName ValidID CalculationFormula))
    {
    ...
    # set specific config
    my $FieldConfig = {
        CalculationFormula => $GetParam{CalculationFormula},
    };
...
sub _Change {
    ...
    # get param and layout object object
    my $ParamObject  = $Kernel::OM->Get('Kernel::System::Web::Request');
    my $LayoutObject = $Kernel::OM->Get('Kernel::Output::HTML::Layout');
...
sub _ShowScreen {
    ...
    $Output .= $LayoutObject->Output(
        TemplateFile => 'AdminDynamicFieldCalculation',
        Data         => {
            %Param,
